...
=====================================================================
* `詳細 <https://qiita.com/tyskJ/items/f5e2335ff6912a375c89>`_
...
* Terraform v1.15.1
* aws-cli/2.32.10 Python/3.13.9 Darwin/25.4.0 exe/arm64
...
.. code-block:: bash
  ...
  key = "aws-systemsmanager-automation-web-automatic-open-close/terraform.tfstate"
...
6. Email 検証
---------------------------------------------------------------------
* 登録したメールアドレス宛に検証メールが届くので本文内のリンクをクリックすること
